...
class CocoDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset):
        ...
        coco = COCO("{}/annotations/SOBA_{}.json".format(dataset_dir, subset))
        image_dir = "{}/{}".format(dataset_dir, "SOBA")
        class_ids = sorted(coco.getCatIds())
        image_ids = list(coco.imgs.keys())
        # Add classes
        for i in class_ids:
            self.add_class("SOBA", i, coco.loadCats(i)[0]["name"])
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            class_id = self.map_source_class_id(
                "SOBA.{}".format(annotation['category_id']))
            if class_id:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN on SOBA.')
